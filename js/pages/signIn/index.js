        ...
        return `
            <div class="sign-in-page">
                <div class="sign-in-main-wrapper">
                    <h1 class="main-title" data-testid="main-title">Façadia</h1>
                    <form class="sign-in-form" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="user-email" data-testid="user-email" id="user-email" type="email" placeholder="email@example.com">
                        ...
                        <div class="form-group">
                            ...
                            <input name="user-password" data-testid="user-password"  id="user-password" type="password" placeholder="mot de passe">
